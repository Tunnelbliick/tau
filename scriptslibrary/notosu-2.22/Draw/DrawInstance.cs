...
namespace StorybrewScripts
{
    ...
    public class DrawInstance : Drawer
    {
        ...
        public OsbEasing easeScale = OsbEasing.None;
        ...
        public DrawInstance(CancellationToken token, Playfield playfieldInstance, double starttime, double easetime, double updatesPerSecond, OsbEasing easing, bool rotateToFaceReceptor)
        {
            this.token = token;
            this.starttime = starttime;
            this.easetime = easetime;
        ...
        public DrawInstance(CancellationToken token, Playfield playfieldInstance, double starttime, double easetime, double updatesPerSecond, OsbEasing easing, bool rotateToFaceReceptor, double fadeInTime, double fadeOutTime)
        {
            this.token = token;
            this.starttime = starttime;
            this.easetime = easetime;
        ...
        public string drawViaEquation(double duration, EquationFunction noteFunction, bool renderReceptor = true, bool enableShadow = false, Vector2 shadowOffset = new Vector2())
        {
            return ByEquation.drawViaEquation(this, duration, noteFunction, renderReceptor, enableShadow, shadowOffset);
        }
